  ...
  return (
    <Dialog
      ...
      <DialogPortal>
        ...
        <DialogContent
          className="pointer-events-auto fixed right-[2%] bottom-[2%] z-[999] max-h-[85vh] w-[90vw] max-w-[500px] rounded-md border border-[var(--color-accent-foreground)] bg-[var(--color-background)] p-[25px]"
          ...
          <div className="mt-[25px] flex justify-end">
            <DialogClose asChild>
              <button className="inline-flex h-[35px] items-center justify-center rounded border border-[var(--color-accent-foreground)] px-[15px] text-[17px] transition duration-[600ms] select-none hover:bg-[var(--color-primary)]">
                Ок
              </button>
            </DialogClose>
          </div>
