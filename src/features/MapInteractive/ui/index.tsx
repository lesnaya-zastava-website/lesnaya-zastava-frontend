...
export const MAP_POINTS: MapPoint[] = [
  { id: 'pl1', title: 'Спортивный комплекс', top: '15%', left: '29%' },
  ...
  { id: 'pl5', title: '1 корпус', top: '26%', left: '44%' },
  { id: 'pl6', title: '2 корпус', top: '25%', left: '51%' },
  { id: 'pl7', title: '3 корпус', top: '25%', left: '56%' },
  { id: 'pl8', title: '4 корпус', top: '25%', left: '61%' },
  { id: 'pl9', title: '5 корпус', top: '25%', left: '66%' },
  { id: 'pl10', title: '6 корпус', top: '37%', left: '67%' },
  { id: 'pl11', title: '7 корпус', top: '29%', left: '34%' },
  { id: 'pl12', title: 'Очистные сооружения', top: '38%', left: '28%' },
  ...
  { id: 'pl18', title: 'Бассейн', top: '45%', left: '36%' },
  { id: 'pl19', title: 'Администрация', top: '50%', left: '52%' },
  { id: 'pl20', title: 'Пляжный волейбол', top: '55%', left: '41%' },
  { id: 'pl21', title: 'Прокат коньков', top: '50%', left: '25%' },
  { id: 'pl22', title: 'Хоз.блок', top: '55%', left: '29.5%' },
  { id: 'pl23', title: 'Здание гаража', top: '59%', left: '34%' },
  { id: 'pl24', title: 'Хоз.блок', top: '63%', left: '38.5%' },
  { id: 'pl25', title: 'Охрана', top: '66%', left: '43%' },
  { id: 'pl26', title: 'Центральные ворота', top: '70%', left: '52%' },
];
          ...
          return (
            <div
              ...
              <button
                ...
                {/* Тултип */}
                <span
                  className={`absolute bottom-full left-1/2 z-50 mb-2 -translate-x-1/2 transform rounded-lg bg-white px-3 py-1 text-sm whitespace-nowrap text-gray-800 shadow-xl transition-all duration-200 ease-out ${
                    isActive
