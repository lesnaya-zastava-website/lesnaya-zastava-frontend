export const Footer: React.FC = () => {
  return (
    <>
      <footer className="items-top flex w-full justify-between px-20 pt-20">
        <div className="w-65">
          <img
            src="./tempLogo.png"
            alt="logo"
        ...
        <div className="w-1/3">
          ...
          <div>
            ...
            <p>
              Телефон/факс: <a href="tel:+73517990151">+7(351)799-01-51</a>
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              Телефон/факс: <a href="tel:+73512694916">+7(351)269-49-16</a>
            </p>
